...
#        print(word_degree[item])
        word_degree[item] = word_degree[item] + word_frequency[item]
#        print(word_degree[item], word_frequency[item])
 #       print('____')
    ...
    for item in word_frequency:
        ...
        #print(word_degree[item], word_frequency[item], word_score[item])
...
class Rake(object):
    def __init__(self, stop_words_path, min_char_length=1, max_words_length=3, min_keyword_frequency=1,
                 min_words_length_adj=1, max_words_length_adj=1, min_phrase_freq_adj=3):
